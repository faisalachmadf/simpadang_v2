											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														...
														<a target="_blank" href="<?= site_url('evlap/temuan/cetak_temuan/'. $temuan->id_temuan .' '); ?>" class="btn btn-primary"><i class="fa fa-print"></i> Cetak Temuan </a>
													</center>
												</div>
											</div>
											...
											<div align="center" class="clearfix form-actions">
												...
												<div class='form-group'>
													...
													<div class='col-sm-10'>
														...
														<textarea required <?php if($temuan->status_usulan == '1') { ?>readonly<?php } else { ?> <?php } ?> class="form-control" name="isi_usulan" rows="5"><?= $temuan->isi_usulan; ?></textarea>
													</div>
												</div>
												<div class='form-group'>
													<label class='col-sm-2 control-label no-padding-right'>&nbsp;</label>
													<div class='col-sm-12'>
														<?php if($temuan->status_usulan == '0') { ?>
														<input style="float: right;" class="btn btn-info" type="submit" name="submit" value="Tindak Lanjut"></input>
														<?php } else { ?>
														<?php } ?>
														<a style="float: right; margin-right: 20px;" href="<?= site_url('evlap/temuan'); ?>" class="btn btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>
													</div>
												</div>
...
<script type="text/javascript">
	$('#modal-kat').on('show.bs.modal', function(e)
	{
		...
		$.ajax({
			type : 'post',
			url  : "<?= site_url('evlap/temuan/get_status'); ?>",
			data : {id1:id1},
...
<script type="text/javascript">
	$('#modal-upload').on('show.bs.modal', function(e)
	{
		...
		$.ajax({
			type : 'post',
			url  : "<?= site_url('evlap/temuan/get_upload'); ?>",
			data : {id1:id1},
			success : function(data)
			{
				$('.isi-data').html(data);
