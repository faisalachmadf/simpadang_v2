										...
										<div class="widget-main">
											...
											<div class="row">
												...
												<div class="col-sm-6">
														...
														<?php
															...
															foreach($data_rev as $row)
															{
																...
																<tr>
																	...
																	<td class='c'>
																		<a href='". site_url('adum/tindak_lanjut/detail_reviu/'.base64_encode($row->rev_tl).'/'.base64_encode($row->rev_ke))."' title='Detail Reviu'> <i class='fa fa-eye bigger-130'></i> </a>
																	</td>
																</tr>
																";
																$no++;
													...
													<form class="form-horizontal" role="form" action="<?= site_url('adum/tindak_lanjut/persetujuan/'. base64_encode($data->id_tl)); ?>" method="post">
													...
													<center>
														<a href="<?= site_url('adum/tindak_lanjut'); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a> <a href="<?= site_url('adum/temuan/detail_temuan/'.$data->id_temuan.''); ?>" class="btn btn-sm btn-primary"> Detail Temuan </a>	
													...
													<div class="alert alert-block alert-success">
														<p>
															<i class='ace-icon fa fa-check'></i> Penugasan Tindak Lanjut Telah Di Reviu.
														</p>
													</div>
