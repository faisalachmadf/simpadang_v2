        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" action="<?php site_url('staff/pkpt/edit_pkpt'); ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $data_pkpt_id['id']; ?>">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <h4 class="header center"> Masukan Perubahan data PKPT </h4>
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-sm-9">
                                                <div class="input-group">
                                                    <select name="tahun" class="chosen-select form-control" id="form-field-select-3">
                                                        ...
                                                        <option value="<?= $data_pkpt_id['tahun']; ?>" selected="selected"><?= $data_pkpt_id['tahun']; ?></option>
                                                        <option value="" style="background-color: yellow;">--Jika Revisi Tahun, Pilih Tahun--</option>
                                          ...
                                          <!--   <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="judul" class="col-xs-10 col-sm-10" placeholder="Judul PKPT" value="<?= $data_pkpt_id['judul']; ?>"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <div class='input-group '>
                                                        file saat ini :
                                                        <a href="<?= site_url('/assets/pkpt/').$data_pkpt_id['nama_file'];?> " title='Download File' download>
                                                             <?= $data_pkpt_id['nama_file']; ?> </a>
                                                            <br/>
                                                            <strong class="form-text text-danger"> Abaikan jika tidak ingin mengUpload File Baru</strong><hr/>
                                            ...
                                            <div align="center" class="clearfix form-actions">
                                                ...
                                                <input class="btn btn-info" type="submit" name="ubah_pkpt" value="ubahkan"></input>                                                      
                                            </div>
                                        </div>
                                    </div>
                                </div>
