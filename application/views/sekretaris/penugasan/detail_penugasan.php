				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('sekretaris/penugasan'); ?>"> Penugasan </a>
							</li>
										...
										<div class="widget-main">
											...
											<div class="col-sm-6">
												...
												<div class="col-sm-6">
														...
														<?php
															...
															foreach($data_rev as $row)
															{
																...
																<tr>
																	...
																	<td class='c'>
																		<a href='". site_url('sekretaris/penugasan/detail_reviu/'.base64_encode($row->rev_tugas1).'/'.base64_encode($row->rev_ke))."' title='Detail Reviu'> <i class='fa fa-eye bigger-130'></i> </a>
																	</td>
																</tr>
																";
																$no++;
													...
													<form class="form-horizontal" role="form" action="<?= site_url('sekretaris/penugasan/persetujuan/'. base64_encode($data->id_tugas)); ?>" method="post">
													...
													<center>
														<a href="<?= site_url('sekretaris/penugasan'); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>		
