				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('sekretaris/tindak_lanjut/detail_tl/'. base64_encode($data->rev_tl). '/'. base64_encode($data->rev_id_tim)); ?>"> Detail Tindak Lanjut </a>
							</li>
										...
										<div class="widget-main">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														<a href="<?= site_url('sekretaris/tindak_lanjut/detail_tl/'. base64_encode($data->rev_tl). '/'. base64_encode($data->rev_id_tim)); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>											
													</center>
