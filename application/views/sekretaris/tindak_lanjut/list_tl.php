						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Melihat tugas yang diberikan kepada ketua tim
								</small>
							</h1>
						</div><!-- /.page-header -->
											...
											<table width="100%" id="mytable" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th width="11%"> Status Reviu </th>
														<th width="11%"> Persetujuan </th>
													</tr>
												</thead>
													...
													<tr>
														...
														<td align='center'>";
															...
															elseif($row->persetujuan == "proses")
																{ echo "<i class='ace-icon fa fa-spinner fa-pulse bigger-130 orange' title='Proses'></i>"; }
