...
<form class='form-horizontal' role='form' action="<?= site_url('daltu/pka/persetujuan_kka/'.base64_encode($kka->sub_pka3).'/'.base64_encode($kka->sub_no_kka).'/'.base64_encode($kka->pelaksana)); ?>" method='post'>
      ...
      foreach($data_rev as $row)
      {
        ...
        <tr>
          ...
          <td class='c pos-atas'>";
            if($row->rev_bukti_kka != NULL || $row->rev_bukti_kka != "")
            {
              ...
              <div class='btn-group'>
                ...
                <ul class='dropdown-menu dropdown-primary'>
                  <li>
                    <a href='".site_url('daltu/pka/download_rev_kka/'.base64_encode($row->rev_hasil_kka))."' title='Download KKA reviu'> Kertas Kerja Audit (KKA)</a>
                  </li>

                  <li>
                    <a href='".site_url('daltu/pka/download_bukti_kka/'.base64_encode($row->rev_bukti_kka))."' title='Download Bukti KKA'> Bukti Pendukung KKA</a>
                  </li>
                </ul>
              </div>";
            }
            ...
            {
              echo "<a href='".site_url('daltu/pka/download_rev_kka/'.base64_encode($row->rev_hasil_kka))."' class='btn btn-sm btn-primary' title='Download KKA reviu'><i class='fa fa-download'></i></a>";
            }
          echo "
          </td>
        </tr>
  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <a href="<?= site_url('daltu/pka/download_kka/'.base64_encode($kka->hasil_kka)); ?>" class='btn btn-sm btn-success' title='Download kertas kerja audit'><i class='fa fa-download'></i> KKA </a>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <a href="<?= site_url('daltu/pka/download_bukti_kka/'.base64_encode($kka->bukti_kka)); ?>" class='btn btn-sm btn-danger' title='Download bukti pendukung KKA'><i class='fa fa-download'></i> Bukti Pendukung KKA </a>
        </div>
      </div>
