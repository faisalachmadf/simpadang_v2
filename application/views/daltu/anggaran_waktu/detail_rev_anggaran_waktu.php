				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('daltu/anggaran_waktu/detail_anggaran_waktu/'.base64_encode($data->rev_agr1)); ?>"> Detail Anggaran Waktu </a>
							</li>
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Melihat rincian hasil reviu anggaran waktu audit
								</small>
							</h1>
						</div><!-- /.page-header -->
										...
										<div class="widget-main">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														<a href="<?= site_url('daltu/anggaran_waktu/detail_anggaran_waktu/'.base64_encode($data->rev_agr1)); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>
													</center>											
												</div>
												...
												<div class="col-sm-6">
													...
													<table width="100%" border="0">
														<tr>
															<td width="27%" class="pos-atas"> Tanggal Reviu DALTU </td>
