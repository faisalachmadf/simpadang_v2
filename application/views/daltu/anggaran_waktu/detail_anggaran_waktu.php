				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('daltu/anggaran_waktu'); ?>"> Anggaran Waktu </a>
							</li>
										...
										<div class="widget-main">
											...
											<div class="row">
														...
														<?php 
															...
															foreach($data_rev as $row)
															{
																...
																<tr>
																	...
																	<td class='c'>
																		<a href='". site_url('daltu/anggaran_waktu/detail_reviu/'.base64_encode($row->rev_agr1).'/'.base64_encode($row->rev_ke))."' title='Detail Reviu'> <i class='fa fa-eye bigger-130'></i> </a>
																	</td>
																</tr>
																";
																$no++;
												...
												<div class="col-sm-6">
													...
													<form class="form-horizontal" role="form" action="<?= site_url('daltu/anggaran_waktu/persetujuan/'. base64_encode($data->id_anggaran_wkt)); ?>" method="post">
													<dl id="dt-list-1" class="dl-horizontal">
													...
													<center>
														<a href="<?= site_url('daltu/anggaran_waktu'); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>		
