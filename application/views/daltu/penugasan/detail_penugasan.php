				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('daltu/penugasan'); ?>"> Penugasan </a>
							</li>
										...
										<div class="widget-main">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														<a href="<?= site_url('daltu/penugasan'); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>														

														<?php //if($data->fk_agr != NULL) { ?>
														<!-- &nbsp;&nbsp;
														<a href="<?= site_url('daltu/anggaran_waktu/detail_anggaran_waktu/'.base64_encode($data->fk_agr)); ?>" class="btn btn-sm btn-primary" title="Detail anggaran waktu">
														...
														<!-- &nbsp;&nbsp;
														<a href="<?= site_url('daltu/pka/detail_pka/'.base64_encode($data->fk_pka)); ?>" class="btn btn-sm btn-primary" title="Detail program kerja audit">
