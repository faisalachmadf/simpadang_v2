					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Mengubah jabatan untuk pegawai
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="validasi" class="form-horizontal" role="form" action="<?php site_url('adm/pengaturan/ubah_jbt'. base64_encode($data->id_set)); ?>" method="post">
								<div class="row">
									<div class="col-md-12">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<input type="text" name="jabatan" class="col-xs-10 col-sm-3" placeholder="Jabatan" value="<?= $data->isi_set; ?>" />
														</div>
													</div>
