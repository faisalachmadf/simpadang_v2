				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active"> Tambah Golongan </li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Menambahkan golongan untuk pegawai
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="validasi" class="form-horizontal" role="form" action="<?php site_url('adm/pengaturan/tambah_gol'); ?>" method="post">
								<div class="row">
									<div class="col-md-12">
