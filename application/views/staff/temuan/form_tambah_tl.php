					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="validasi" class="form-horizontal" role="form" action="<?php site_url('staff/temuan/tambah_tl'); ?>" method="post">
								<div class="row">
									<div class="col-md-12">
			                    ...
			                    <input type="hidden" name="id_temuan" value="<?= $sasaran->id_temuan; ?>">
			                    ...
			                    <div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<input required type='text' name='sasaran_peng' class='col-xs-12 col-sm-5' placeholder='Sasaran Tindak Lanjut' readonly='' value='<?= $sasaran->no_lhp; ?> - <?= $sasaran->instansi; ?>' />
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<div class='input-group date datepicker'>
																<span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
																<input type='text' name='tgl_surat' class='col-xs-8 col-sm-2' placeholder='Tanggal Surat' required value='<?= $tgl; ?>' />
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<div class='input-group date datepicker'>
																<span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
																<input type='text' name='tgl_awal' class='col-xs-8 col-sm-2' placeholder='Dari Tanggal' required />
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<div class='input-group date datepicker'>
																<span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
																<input type='text' name='tgl_akhir' class='col-xs-8 col-sm-2' placeholder='Sampai Tanggal' required />
															</div>
														</div>
													</div>
													...
													<div align="center" class="clearfix form-actions">
														...
														<a href="<?php site_url('staff/temuan/tambah_tl'); ?>" class="btn btn-danger"><i class="ace-icon fa fa-refresh bigger-110"></i> Bersihkan</a>
      ...
      //Jumlah anggota
			...
			function tambahElemenAgt() {
			  ...
			  else
			  {
			  	var stre;
			  	stre = "<p id='arow" + ke + "'>" +
			  	"	<select required id='tbh_agt" + ke + "' name='anggota[]' class='select2 required' data-placeholder='-- Pilih Anggota Ke-" + ke + " --'>" +
