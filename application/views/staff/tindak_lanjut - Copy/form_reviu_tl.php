							...
							<div class="col-xs-12">
			                    ...
			                    <input type="hidden" name="no_rev" value="<?= $rev_ke; ?>">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<?php 
																if($data->instansi_kec != "-")
																{
																	echo "
																	<input type='text' name='sasaran_peng' class='col-xs-10 col-sm-7' placeholder='Sasaran pengawasan' value='$data->sasaran_peng $tes' />
																...
																{
																	echo "
																	<input type='text' name='sasaran_peng' class='col-xs-10 col-sm-7' placeholder='Sasaran pengawasan' value='$data->sasaran_peng' />																	
																	<input type='hidden' name='kecamatan' value='$data->instansi_kec' />
													...
													<?php if($data->instansi_kec == "-") { ?>
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right"> Kecamatan </label>
														<div class="col-sm-9">
															<input type='text' name='kecamatan2' class='col-xs-10 col-sm-4' value='<?= $data->kecamatan; ?>' readonly />
														</div>
													</div>
													<?php } ?>
