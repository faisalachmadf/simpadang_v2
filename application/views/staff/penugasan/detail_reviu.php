				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('staff/penugasan/detail_penugasan/'. base64_encode($data->rev_tugas1). '/'. base64_encode($data->rev_id_tim)); ?>"> Detail Penugasan </a>
							</li>
										...
										<div class="widget-main">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														<a href="<?= site_url('staff/penugasan/detail_penugasan/'. base64_encode($data->rev_tugas1). '/'. base64_encode($data->rev_id_tim)); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>
													</center>
