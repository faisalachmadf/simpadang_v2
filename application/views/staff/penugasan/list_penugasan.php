						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Membuat dan mengelola penugasan tim audit
								</small>
							</h1>
						</div><!-- /.page-header -->
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<label>
											<a href="<?php echo site_url('staff/penugasan/tambah_penugasan'); ?>" class="btn btn-info" title="Tambah penugasan"><i class="fa fa-plus-square fa-lg"></i>&nbsp; Tambah Penugasan Baru</a>
										</label>
