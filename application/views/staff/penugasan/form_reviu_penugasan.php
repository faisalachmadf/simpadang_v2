							...
							<div class="col-xs-12">
			                    ...
			                    <input type="hidden" name="no_rev" value="<?= $rev_ke; ?>">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<select required name="daltu" class="select2" data-placeholder="Pilih Wakil Penanggung Jawab">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<textarea required name="nama_kp" rows="3" cols="74" placeholder="Nama kegiatan pengawasan"><?= $data->nama_kp; ?></textarea>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<textarea required name="nama_op" rows="3" cols="74" placeholder="Nama objek pengawasan"><?= $data->nama_op; ?></textarea>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<textarea required name="alamat_kantor" rows="3" cols="50" placeholder="Alamat kantor"><?= $data->alamat_kantor; ?></textarea>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<input required type="text" name="no_tlp" class="col-xs-10 col-sm-3" placeholder="Nomor telepon" value="<?= $data->no_tlp; ?>" />
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															...
															<input type="hidden" name="kecamatan" value="<?= $data->instansi_kec; ?>"/>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<textarea required name="tujuan_peng" rows="5" cols="74" placeholder="Tujuan pengawasan"><?= $data->tujuan_peng; ?></textarea>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<textarea required name="tujuan_lap" rows="3" cols="50" placeholder="Penerima laporan pemeriksaan"><?= $data->tujuan_laporan; ?></textarea>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-5">
															<input required type="text" name="no_surat" class="col-xs-12 col-sm-5" value="<?= $data->no_surat; ?>" readonly=''>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-5">
															<textarea required name="dasar_surat" rows="3" cols="60" placeholder="Dasar surat"><?= $data->dasar_surat; ?></textarea>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<div class='input-group date datepicker'>
																...
																<input required type='text' name='tgl_awal' class='col-xs-8 col-sm-2' placeholder='Dari Tanggal' value="<?= $data->tgl_awal; ?>" />
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<div class='input-group date datepicker'>
																<span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
																<input required type='text' name='tgl_akhir' class='col-xs-8 col-sm-2' placeholder='Sampai Tanggal' value="<?= $data->tgl_akhir; ?>" />
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															...
															<?php
																...
																{
																	echo "<p id='trow$row->nomor'><input required type='text' name='tembusan[]' size='70' value='$row->tembusan' placeholder='Tembusan 1' />
													...
													<div align="center" class="clearfix form-actions">
														...
														<a href="<?php site_url('staff/penugasan/reviu_penugasan/'. base64_encode($data->id_tugas) .'/'. base64_encode($data->id_tim)); ?>" class="btn btn-danger"><i class="ace-icon fa fa-refresh bigger-110"></i> Bersihkan</a>
