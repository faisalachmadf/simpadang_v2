                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class='input-group date datepicker2'>
                                                        ...
                                                        <input type='text' name='tgl_tgs' class='col-xs-8 col-sm-2' placeholder='Tanggal' readonly='' required/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="nama_kp" rows="3" cols="74" placeholder="Nama kegiatan pengawasan"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="nama_op" rows="3" cols="74" placeholder="Nama objek pengawasan"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="alamat_kantor" rows="3" cols="50" placeholder="Alamat kantor"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="no_tlp" class="col-xs-10 col-sm-3" placeholder="Nomor telepon" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="program_peng" class="col-xs-10 col-sm-8" placeholder="Program pengawasan" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="tujuan_peng" rows="5" cols="74" placeholder="Tujuan pengawasan"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="tujuan_lap" rows="3" cols="50" placeholder="Penerima laporan pemeriksaan"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class='input-group date datepicker2'>
                                                        <span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
                                                        <input type='text' name='tgl_surat' class='col-xs-8 col-sm-2' placeholder='Tanggal' readonly='' />
                                                    </div>
                                                </div>
                                            </div>
            ...
            rules:
                    {
                        ...
                        no_surat: {
                            required: true,
                            remote: {
                                url: "<?= site_url('staff/penugasan/get_no_surat'); ?>",
                                type: "post",
                                data: {
                                    no_surat: function () {
                                ...
                                complete: function (e) {
                                    if (e.responseJSON.status) {
                                        ...
                                        $.ajax({
                                            type: 'post',
                                            url: "<?= site_url('staff/penugasan/get_no_surat_baru'); ?>",
                                            dataType:'JSON',
