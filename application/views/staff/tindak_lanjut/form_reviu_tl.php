							...
							<div class="col-xs-12">
			                    ...
			                    <input type="hidden" name="no_rev" value="<?= $rev_ke; ?>">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<input type='text' name='sasaran_peng' class='col-xs-12 col-sm-5' placeholder='Sasaran Tindak Lanjut' required value='<?= $data->sasaran_peng; ?>' />
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-5">
															<input type="text" name="no_surat" class="col-xs-12 col-sm-5" value="<?= $data->no_surat; ?>" required>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<div class='input-group date datepicker'>
																...
																<input type='text' name='tgl_awal' class='col-xs-8 col-sm-2' placeholder='Dari Tanggal' required value="<?= $data->tgl_awal; ?>" />
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<div class='input-group date datepicker'>
																<span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
																<input type='text' name='tgl_akhir' class='col-xs-8 col-sm-2' placeholder='Sampai Tanggal' required value="<?= $data->tgl_akhir; ?>" />
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															...
															<?php
																...
																{
																	echo "<p id='trow$row->nomor'><input type='text' name='tembusan[]' size='70' required value='$row->tembusan' placeholder='Tembusan 1' />
													...
													<div align="center" class="clearfix form-actions">
														...
														<a href="<?php site_url('staff/tindak_lanjut/reviu_tl/'. base64_encode($data->id_tl) .'/'. base64_encode($data->id_tim)); ?>" class="btn btn-danger"><i class="ace-icon fa fa-refresh bigger-110"></i> Bersihkan</a>
      ...
      //Jumlah anggota
	      ...
	      function tambahElemenAgt() {
	      	...
	      	else
	      	{
	      		var stre;
	      		stre = "<p id='arow" + ke + "'>" +
	      		"	<select required id='tbh_agt" + ke + "' required name='anggota[]' class='select2 required' data-placeholder='-- Pilih Anggota Ke-" + ke + " --'>" +
