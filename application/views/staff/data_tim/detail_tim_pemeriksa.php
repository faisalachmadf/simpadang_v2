				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active"> Detail Tim Pemeriksa </li>
						</ul><!-- /.breadcrumb -->
					</div>
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Melihat rincian data tim pemeriksa
								</small>
							</h1>
						</div><!-- /.page-header -->
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													<h3 class="header">
														<i class="fa fa-file-text"></i> Surat Tim Pemeriksa
													</h3>
													...
													<center>
														...
														&nbsp;&nbsp;
														<a href="<?= site_url('adum/data_tim/cetak_surat_pemeriksa/'.base64_encode($data->id_tim)); ?>" class="btn btn-sm btn-danger" target="_blank"><i class="fa fa-print"></i> Cetak Surat Pemeriksaan </a>
													</center>
