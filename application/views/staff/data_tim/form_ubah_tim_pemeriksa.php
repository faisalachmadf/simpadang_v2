				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active"> Ubah Tim Pemeriksa </li>
						</ul><!-- /.breadcrumb -->
					</div>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<!-- ID Tim -->
			                    <input type="text" name="id_tim" value="<?= $data->id_tim; ?>">

			                    <div class="form-group">
														<label class="col-sm-3 control-label no-padding-right"></label>
														<div class="col-sm-5">
															<h4 class="header center"> Data tim pemeriksa yang dibuat. </h4>
														</div>
													</div>

													<?php $cek_dalnis = $data->dalnis; ?>
													<div class="form-group">
														...
														<div class="col-sm-9">
															<div class="radio">
																<label>
																	<input type="radio" name="stat_dalnis" class="ace dalnis" id="dalnis-ada" value="ya" <?php if($cek_dalnis != NULL) { echo "checked"; } ?> />
																	<span class="lbl"> Ya </span>
																</label>

																<label>
																	<input type="radio" name="stat_dalnis" class="ace dalnis" value="tidak" <?php if($cek_dalnis == NULL) { echo "checked"; } ?> />
																...
																<select name="dalnis" class="select2" data-placeholder="Pilih Pengendali Teknis">
																	...
																	<?php
																		foreach($dalnis as $row)
																		{
																			...
																			if($data->dalnis == $row->nama) { echo "selected"; }
														...
														<div class="col-sm-9">
															<select name="ketua_tim" class="select2" data-placeholder="Pilih Ketua Tim">
																...
																<?php
																	...
																	{
																		echo "<option value='$row->nama'";
																		if($data->ketua_tim == $row->nama) { echo "selected"; }
																		echo "> $row->nama </option>";
																	}
																?>
															</select>
														...
														<div class="col-sm-9">
																...
																<?php
																	foreach($anggota as $row)
																	{
																		foreach($tim as $row2)
																		{
																			...
																			{
																				echo "<option value='$row->nama'";
																				if($row2->anggota == $row->nama) { echo "selected"; }
																				echo "> $row->nama </option>";
																			}
																		}
																	}
															...
															<?php
																foreach($tim as $row2)
																{
																	...
																	{
															?>
															<p id='agtrow<?= $row2->nomor; ?>'>
																<select name='anggota[]' class='select2' data-placeholder='Pilih Anggota Ke-<?= $row2->nomor; ?>'>
																	<option> &nbsp; </option>
																	<?php
																		foreach($anggota as $row)
																		{
															 	...
															 	<a href='#' onclick='hapusElemenAgt("#agtrow<?= $row2->nomor; ?>"); return false;' class='btn btn-sm btn-danger' title='Hapus anggota ke-<?= $row2->nomor; ?>'> <i class='fa fa-minus'></i> </a>
															</p>
															<?php } } ?>
													...
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right"></label>
														<div class="col-sm-5">
															<h4 class="header center"> Data surat tugas tim pemeriksa. </h4>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															...
															<div id="form-tembusan">
																<input name="jml_tbs" id="ke3" value="2" type="hidden" />
