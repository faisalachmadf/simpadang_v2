...
<html>
    <head>
        ...
        <title> Surat Tugas Pemeriksaan : <?= $data->no_surat; ?> </title>
    ...
    <body>
        ...
        <p class="f16 b c u pad-b-5" align="center"> SURAT PERINTAH PEMERIKSAAN </p> <br/>
                    ...
                    <td colspan="5">
                        <table width="100%" border="0">
                            <tr>
                                ...
                                <td><?= $daltu->nama; ?></td>
                                <td width="5%"> : </td>
                                <td width="23%" class="c"> Wakil Penanggung Jawab </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><?= $dalnis->nama; ?></td>
                                <td width="5%"> : </td>
                                <td width="23%" class="c"> Pengendali Teknis </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="5%"> : </td>
                                <td width="23%" class="c"> Ketua Tim </td>
                            </tr>
                                ...
                                if ($row->anggota != NULL) {
                                    echo "
                                        <tr>
                                                ...
                                                <td> $row->nama </td>
                                                <td width='5%'> : </td>
                                                <td width='23%' class='c'> Anggota Tim </td>
                                        </tr>";
                                }
                            }
                            ?>
                    ...
                    <td colspan="5" align="justify">
                        <table width="100%" border="0">
                            ...
                            if ($data->stat_sasaran == "pilih") {
                                ...
                                echo "
                                    <tr>
                                        <td colspan='2'>$data->sasaran_peng <!-- Kecamatan $data->kecamatan--></td>
                                    </tr>";
                            }
                            ?>
                        </table>
...
<?php } else { ?>
                    <tr>
                        <td colspan="5"></td>
                        <td class="c"><img src="./assets/verifikasi/<?= $data->ttd; ?>" width="210" height="80"></td>
                        <td></td>
                    </tr>
<?php } ?>			
