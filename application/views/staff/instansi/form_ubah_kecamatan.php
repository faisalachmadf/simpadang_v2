					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="validasi" class="form-horizontal" role="form" action="<?= site_url('staff/instansi/ubah_kecamatan/'. base64_encode($data->id_instansi)); ?>" method="post">
								<div class="row">
									<div class="col-md-12">
			                    ...
			                    <div class="form-group">
														...
														<div class="col-sm-9">
															<input type="text" name="nama_kecamatan" class="col-xs-10 col-sm-5" placeholder="Nama kecamatan" value="<?= $data->nama_kecamatan; ?>" />
														</div>
													</div>													
