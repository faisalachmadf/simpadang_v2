                                                    ...
                                                    <center>
                                                        <a href="<?= site_url('irban/notadinas'); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>
                                                         &nbsp;&nbsp;
                                                            ...
                                                            <?php } else { ?>
                                                             <a href="<?= site_url('irban/notadinas/cetak_notadinas/'.$notadinass["notadinas_id"].''); ?>" class="btn btn-sm btn-danger" target="_blank"><i class="fa fa-print"></i> Preview Nota Dinas </a>
                                                             <hr/>

                                                            <a href="<?= site_url('irban/notadinas/ubah_notadinas/'.$notadinass["notadinas_id"].''); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit'></i"></i> Ubah Nota Dinas </a>
                                                             
                                                            <hr/>
                                                           <?= form_open_multipart('irban/notadinas/kirim_notadinas'); ?>
                                                                <input type="hidden" name="status" value="1">
                                                                <input type="hidden" name="notadinas_id" value="<?= $notadinass['notadinas_id']; ?>">

                                                                <input class="btn btn-sm btn-success" onclick="return confirm('Nota Dinas ini akan dikirimkan kepada Ketua Tim?') ;" type="submit" value="Kirim Nota Dinas"></input>
                                                                <!-- <a class="btn btn-sm btn-success" type="submit" ><i class="fa fa-arrow-right'></i"></i> Kirim Nota Dinas </a> -->
                                                            </form>
