        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form id="validasis" class="form-horizontal" role="form" action="<?php site_url('irban/notadinas/ubah_notadinas'); ?>" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <!-- ID Nota Dinas -->
                                            <input type="hidden" name="notadinas_id" value="<?= $notadinass['notadinas_id']; ?>">
                                            <!-- ID Tim -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class='input-group date datepicker2'>
                                                        ...
                                                        <input type='text' name='tgl' class='col-xs-8 col-sm-2' placeholder='Tanggal' value="<?= $notadinass['tgl']; ?>" required /> <small class="form-text text-danger"><?= form_error('tgl'); ?></small>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">  
                                                    <input required type="text" name="nomor" class="col-xs-12 col-sm-5" value="<?= $notadinass['nomor']; ?>"><small class="form-text text-danger"><?= form_error('nomor'); ?></small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <?php
                                                                foreach($tim as $row)
                                                                {
                                                                    $keyAgt = $row->id_pegawai;
                                                                ?>
                                                                    <p id="t<?=$row->nomor;?>">
                                                                        <select required name="anggota[]" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea required name="hal" rows="3" cols="74" placeholder="hal Pengawasan" ><?= $notadinass['hal']; ?></textarea><small class="form-text text-danger"><?= form_error('hal'); ?></small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea required name="nama_objek" rows="3" cols="74" placeholder="Nama objek pengawasan" ><?= $notadinass['nama_objek']; ?></textarea><small class="form-text text-danger"><?= form_error('nama_objek'); ?></small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input required type="text" required name="sasaran_peng" class="col-xs-10 col-sm-8" placeholder="Sasaran pengawasan" value="<?= $notadinass['sasaran_peng']; ?>" />
                                                <small class="form-text text-danger"><?= form_error('sasaran_peng'); ?></small>
                                                <?php $keyKec = $data->sasaran; ?>
                                                &nbsp;

                                                <label class="control-label">
                                                    <input type="checkbox" name="pilih_sasaran" id="pilih-sasaran" class="ace" <?php if($keyKec != NULL) { echo "checked"; } ?> />
                                                ...
                                                <input type="hidden" name="kecamatan" value="<?= $data->sasaran; ?>"/>
                                                    ...
                                                    <div class="form-sasaran">
                                                                ...
                                                                foreach($sasaran as $row)
                                                                {
                                                                    ...
                                                                    ?>
                                                                    <p id="ss<?=$row->nomor;?>">
                                                                        <select name="sasaran[]" class="desa" data-placeholder="-- Pilih Instansi --">
                                                                            <option disabled selected></option>
                                                                            <?php
                                                                            foreach($desa as $row)
                                                                            {
                                                                                echo "<option value='$rows->nama_desa' ";
                                                                                if($keyIns == $row->nama_desa)
                                                                                    {   echo "selected='selected'"; }
                                                                                echo "> $row->nama_desa </option>";
                                                                            }
                                                                            ?>
                                                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class='input-group date datepicker'>
                                            <span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
                                            <input required type='text' name='tgl_awal' class='col-xs-8 col-sm-2' placeholder='Dari Tanggal'    value="<?= $notadinass['tgl_awal']; ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class='input-group date datepicker'>
                                            <span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
                                            <input  required type='text' name='tgl_akhir' class='col-xs-8 col-sm-2' placeholder='Sampai Tanggal'  value="<?= $notadinass['tgl_akhir']; ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input required type="text" name="lampiran" class="col-xs-12 col-sm-5" value="<?= $notadinass['lampiran']; ?>"><small class="form-text text-danger"><?= form_error('lampiran'); ?></small>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea  name="isi_nota" id="ckeditor" class="ckeditor" ><?= $notadinass['isi_nota']; ?></textarea><small class="form-text text-danger"><?= form_error('isi_nota'); ?></small>
                                    </div>
                                </div>
                                ...
                                <div align="center" class="clearfix form-actions">
                                    ...
                                    <input class="btn btn-info" type="submit" name="submit" value="Ubah Nota Dinas"></input>														
                                </div>
