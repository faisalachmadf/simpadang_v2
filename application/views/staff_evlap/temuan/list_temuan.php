					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<label>
									<a href="<?php echo site_url('staff_evlap/temuan/tambah_tl'); ?>" class="btn btn-info" title="Tambah Temuan"><i class="fa fa-plus-square fa-lg"></i>&nbsp; Tambah Temuan</a>
								</label>
								<div class="row">
									<div class="col-xs-12">
											...
											<table width="100%" id="mytable" class="table table-striped table-bordered table-hover">
												...
												foreach ($tl as $row)
												{
													...
													<tr>
														...
														<td>
														$row->instansi
														<a href='temuan/detail_temuan/$id' title='Detail Temuan'>
															<span class='pull-right'> <i class='ace-icon fa fa-list bigger-130'></i> </span>
														</a>
														</td>
														<td>$row->kategori_lhp</td>
													</tr>";
