	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form id="validasi" class="form-horizontal" role="form" action="<?php site_url('ketua_tim/tindak_lanjut/tambah'); ?>" method="post" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-12">
...
<div class="kategori">
	...
	<script type="text/javascript">
		function tbhTemuanSpi() {
			...
			var stre;
			stre  = "<div id='spi_trow" + temuan_spi1 + "' class='co-row'>";

				stre += "<div class='row'>";
					stre += "<div class='col-sm-6 tb-border mb10'>";
				...
				stre += "<div class='row'>";
					stre += "<div class='col-sm-6 tb-border'>";
					stre += "<textarea rows='4' class='form-control' placeholder='Temuan'  name='judul_spi["+ temuan_spi1+"]'></textarea>";
					stre += "</div>";
					stre += "<div class='col-sm-3 tb-border'>";
					stre += "<select class='form-control' name='kode_temuan_spi["+ temuan_spi1+"]'>";
			...
			stre += "<br>";
			stre += "<hr><a  style='float:left;' onclick='hpsTemuanSpi(\"#spi_trow" + temuan_spi1 + "\"); return false;' class='btn btn-sm btn-danger'> <i class='fa fa-times'></i> Hapus Temuan SPI " + judul_temuan_spi + "</a> <button  style='float:right;' type='button' class='btn btn-sm btn-warning' onclick='tbhUraianSpi(" + temuan_spi1 + "); return false;' title='Tambah Rekomendasi'><i class='fa fa-plus'></i> Tambah Rekomendasi </button>";
			...
			stre += "<label class='control-label'></label>";
			stre += "</div>";
			stre += "</div>";
		...
		function tbhUraianSpi($ids) {
			...
			stre = "<div id='spi_trow" + spi1 + $ids +"' class='row' style='display: block;'> ";
			stre += "<hr>";
			stre += "<div class='col-sm-6'>";
			stre += "<label class='control-label'>Uraian Rekomendasi</label>";
			stre += "<textarea name='uraian_spi_"+ $ids +"[]' placeholder='Uraian Rekomendasi' class='form-control'></textarea>";
			stre += "</div>";
			stre += "<div class='col-sm-2'>";
			stre += "<label class='control-label no-padding-right'>Kode Rekomendasi</label>";
			...
			stre += "<div class='col-sm-2'>";
			stre += "<label class='control-label'>Nilai</label>";
			stre += "<input type='text' name='nilai_spi_"+ $ids +"[]' placeholder='Nilai' class='form-control'></input>";
			stre += "</div>";

			stre += "<div class='col-sm-2'>";
			stre += "<a onclick='hpsUraianSpi(\"#spi_trow" + spi1 + $ids +"\"); return false;' class='btn btn-sm btn-danger mt20' title='Hapus uraian_spi_ "+ spi1 +"'> <i class='fa fa-times'></i></a>";
			stre += "</div>";
