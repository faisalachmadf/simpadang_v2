    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form id="validasi" class="form-horizontal" role="form" action="<?php echo site_url('ketua_tim/tindak_lanjut/tambah_tl/').base64_encode($data->no_lhp)?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="widget-body" style="display: block; overflow: hidden;">
                                        <div class="widget-main">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <input required type="text" class="form-control" name="instansi" class="col-xs-12 col-sm-5" value="<?= $data->nm_instansi; ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <input required type="text" class="form-control" name="no_lhp" class="col-xs-12 col-sm-5" value="<?= $data->no_lhp; ?>" readonly>
                                                </div>
                                            </div>
                ...
                $(document)
                        .on('click', '#TambahUraian', function () {
                            var list =
                                    ...
                                    "</div>" +
                                    "<div class='col-md-3'>" +
                                    "<button type='button' class='btn pull-right btn-sm btn-danger' style='margin:5px' id='HapusUraian' data-no='1' title='Hapus Temuan'><i class='fa fa-minus'></i> Hapus Temuan</button>" +
                                    "</div>" +
                                    "</div>" +
                                    "<div class='col-md-12' style='min-height: 170px;padding: 10px 0px'>" +
