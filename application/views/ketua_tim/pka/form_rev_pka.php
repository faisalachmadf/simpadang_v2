        ...
        <div class="page-content">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input required type="text" name="masa_periksa" class="col-xs-10 col-sm-4" placeholder='Tahun anggaran' value="<?= $data->masa_periksa; ?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input required type="text" name="no_ref_pka" class="col-xs-10 col-sm-2" placeholder='Nomor Ref.' value="<?= $data->no_ref_pka; ?>" />
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    foreach ($sub1 as $row) {
                                                        if ($row->tujuan_pka != NULL) {
                                                            if ($row->nomor == 1) {
                                                                echo "<textarea required name='tjn_pka[]' rows='3' cols='60' placeholder='Isi tujuan PKA'>$row->tujuan_pka</textarea>
                                                                ...
                                                                <textarea required name='tjn_pka[]' rows='3' cols='60' placeholder='Isi tujuan PKA'>$row->tujuan_pka</textarea>
                                            ...
                                            <div class="tabbable">
                                                <ul class="nav nav-tabs" id="myTab">
                                                    <li id="a-persiapan" class="active">
                                                        <a data-toggle="tab" href="#persiapan" aria-expanded="true">
                                                            1. PERSIAPAN AUDIT 
                                                        </a>
                                                    </li>

                                                    <li id="a-pelaksanaan" class="">
                                                        <a data-toggle="tab" href="#pelaksanaan" aria-expanded="false">
                                                            2. PELAKSANAAN AUDIT
                                                        </a>
                                                    </li>
                                                    <li id="a-penyelesaian" class="">
                                                        <a data-toggle="tab" href="#penyelesaian" aria-expanded="false">
                                            ...
                                            <div class="tab-content">
                                                <div id="persiapan" class="tab-pane fade active in">
                                                    <table width="100%" border="0">
                                                        <tr>
                                                            <th width="3%"></th>
                                                            <th></th>
                                                            ...
                                                            foreach ($ins as $key) {
                                                                ...
                                                                foreach ($sub1 as $row) {
                                                                    if ($row->kategori == "1" && $row->nama_instansi == $key->nama_instansi) {
                                                                        echo "<input type='hidden' name='kategori[]' id='kategori-$no_kat1' value='$row->kategori'>
                                                                        ...
                                                                        foreach ($sub2 as $row3) {
                                                                            if ($row3->kode_uraian == "$no_ins1-$no_kat1-A") {
                                                                                if ($row3->no_kka == "a") {
                                                                                    ...
                                                                                    echo "<tr id='ttjn_row-$no_ins1$no_kat1' class='bor-bot'>
                                                                                    <td width='3%'></td>
                                                                                    <td>
                                                                                    <input type='hidden' name='kode_periksa[]' value='A'>
                                                                                    <input type='hidden' name='no_ins[]' value='$no_ins1'>
                                                                        ...
                                                                        foreach ($sub2 as $row3) {
                                                                            if ($row3->kode_uraian == "$no_ins1-$no_kat1-B") {
                                                                                if ($row3->no_kka == "$row->kategori.$abj_ins1.$no_kat1.a") {
                                                                                    ...
                                                                                    foreach ($sub3 as $row4) {
                                                                                        if ($row4->sub_no_kka == $row3->no_kka) {
                                                                                            if ($row4->nomor == 1) {
                                                                                                ...
                                                                                                <select required name='pelaksana[]'>
                                                                                                <option value=''> -- Pilih Pelaksana -- </option>";

                                                                                                echo "<option value='KOSONG** $no_kat1'";
                                                                                                if ($pelaksana == 'KOSONG**') {
                                                                                                    echo 'selected';
                                                                                                } echo "> NULL </option>";
                                                                                                foreach ($anggota as $row2) {
                                                                                                    echo "<option value='$row2->anggota $no_kat1'";
                                                                                                    if ($pelaksana == $row2->anggota) {
                                                                                                        echo 'selected';
                                                                                                    } echo "> $row2->nama [ANGGOTA] </option>";
                                                                                                }
                                                                                                echo "</select>
                                                                                    ...
                                                                                    <input type='text' name='tanggal[]' class='col-xs-10 col-sm-12' placeholder='Tanggal' required value='$row3->tgl_kerja' />
            ...
            //-> KONDISI 1 INSTANSI
                                                    ...
                                                    <div align="center" class="clearfix form-actions">
                                                        <a id="next-pelaksanaan" data-toggle="tab" href="#pelaksanaan" class="btn btn-default ">
                                                ...
                                                <div id="pelaksanaan" class="tab-pane fade">
                                                    <table width="100%" border="0">
                                                        <tr>
                                                            <th width="3%"></th>
                                                            <th></th>
                                                                                    ...
                                                                                    foreach ($sub3 as $row4) {
                                                                                        if ($row4->sub_no_kka == $row3->no_kka) {
                                                                                            if ($row4->nomor == 1) {
                                                                                                ...
                                                                                                echo "<option value='KOSONG** $no_kat2'";
                                                                                                if ($pelaksana == 'KOSONG**') {
                                                                                                    echo 'selected';
                                                                                                } echo "> NULL </option>";
                                                                                                foreach ($anggota as $row2) {
                                                                                                    echo "<option value='$row2->anggota $no_kat2'";
                                                                                                    if ($pelaksana == $row2->anggota) {
                                                                                                        echo 'selected';
                                                                                                    } echo "> $row2->nama [ANGGOTA] </option>";
                                                                                                }
                                                                                ...
                                                                                foreach ($sub3 as $row4) {
                                                                                    if ($row4->sub_no_kka == $row3->no_kka) {
                                                                                        if ($row4->nomor == 1) {
                                                                                            ...
                                                                                            <input type='hidden' name='nomor[]' value='$row4->nomor'>
                                                                                            <select required name='pelaksana[]'>
                                                                                            <option vallue=''> -- Pilih Pelaksana -- </option>";
                                                                                            echo "<option value='KOSONG** $no_kat2'";
                                                                                            if ($pelaksana == 'KOSONG**') {
                                                                                                echo 'selected';
                                                                                            } echo "> NULL </option>";
                                                    ...
                                                    <div align="center" class="clearfix form-actions">
                                                        ...
                                                        <a id="back-persiapan" data-toggle="tab" href="#persiapan"  class="btn btn-default ">
                                                            <i class="fa fa-arrow-left"></i> Kembali
                                                        </a>

                                                        &nbsp; &nbsp;

                                                        <a id="next-penyelesaian" data-toggle="tab" href="#penyelesaian" class="btn btn-default ">
                                                            <i class="fa fa-arrow-right"></i> Selanjutnya
                                                        </a>
                                                    </div>

                                                </div>
                                                <div id="penyelesaian" class="tab-pane fade">
                                                    <table width="100%" border="0">
                                                        <tr>
                                                            <th width="3%"></th>
                                                            <th></th>
                                                                                    ...
                                                                                    foreach ($sub3 as $row4) {
                                                                                        if ($row4->sub_no_kka == $row3->no_kka) {
                                                                                            if ($row4->nomor == 1) {
                                                                                                ...
                                                                                                <select required name='pelaksana[]'>
                                                                                                <option value=''> -- Pilih Pelaksana -- </option>";
                                                                                                echo "<option value='KOSONG** $no_kat3'";
                                                                                                if ($pelaksana == 'KOSONG**') {
                                                                                                    echo 'selected';
                                                                                                } echo "> NULL </option>";
                                                                                                foreach ($anggota as $row2) {
                                                                                                    echo "<option value='$row2->anggota $no_kat3'";
                                                                                                    if ($pelaksana == $row2->anggota) {
                                                                                                        echo 'selected';
                                                                                                    } echo "> $row2->nama [ANGGOTA] </option>";
                                                                                                }
                                                    ...
                                                    <div align="center" class="clearfix form-actions">
                                                        <a id="back-pelaksanaan" data-toggle="tab" href="#pelaksanaan"  class="btn btn-default ">
                                                            <i class="fa fa-arrow-left"></i> Kembali
                                                        </a>

                                                        &nbsp; &nbsp;
                                                        
                                                        <a class="btn btn-danger" href="<?= site_url('ketua_tim/pka/reviu_pka/' . base64_encode($data->id_pka) . '/' . base64_encode($data->id_tgs) . '/' . base64_encode($data->id_tim)) ?>">
...
<script type="text/javascript">
    $("[name='submit']").click(function(){
        $('#validasi input:required, #validasi select:required').each(function() {
          if ($(this).val() === '')
            if (window.confirm("Data belum terisi lengkap! Silahkan periksa kembali form isian Anda!")) {
                exit();
            }
    ...
    $('#next-pelaksanaan').click(function() {
        //window.alert("Apakah data yang Anda isi sudah lengkap ?");
        $('li#a-persiapan').removeClass('active');
        $('li#a-pelaksanaan').addClass('active');
    });

    $('#back-persiapan').click(function() {
        $('li#a-pelaksanaan').removeClass('active');
        $('li#a-persiapan').addClass('active');
    });

    $('#back-pelaksanaan').click(function() {
        $('li#a-penyelesaian').removeClass('active');
        $('li#a-pelaksanaan').addClass('active');
    });

    $('#next-penyelesaian').click(function() {
        //window.alert("Apakah data yang Anda isi sudah lengkap ?");
        $('li#a-pelaksanaan').removeClass('active');
        $('li#a-penyelesaian').addClass('active');
    });
...
<script type="text/javascript">
    ...
    function tambahElemenLkh(form_lkh, kode_ins, no_ins, kode_tbl)
    {
        ...
        if (abjad != '{')
        {
            ...
            "	<td class='pad-3'> <select required name='pelaksana[]'>" +
            "		<option value=''> -- Pilih Pelaksana -- </option>" +
            ...
            foreach ($anggota as $row) {
                ...
                "			<input type='text' name='tanggal[]' class='col-xs-10 col-sm-12' placeholder='Tanggal' required />" +
                "		<span class='input-group-addon' title='Pilih Tanggal'><span class='ace-icon fa fa-calendar bigger-110'></span></span>" +
                "	</div> </td>" +
