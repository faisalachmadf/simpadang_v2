...
<form class='form-horizontal' role='form' action="<?= site_url('ketua_tim/pka/persetujuan_kka_ikhtisar/'.base64_encode($kka->sub_pka2).'/'.base64_encode($kka->no_kka)); ?>" method='post'>
