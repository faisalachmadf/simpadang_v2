                                        ...
                                        <div class="widget-main">
                                            ...
                                            <!-- <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="masa_periksa" class="col-xs-10 col-sm-4" placeholder='Tahun anggaran' value="Tahun anggaran <?= date('Y'); ?>" required/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="text" name="no_ref_pka" class="col-xs-10 col-sm-2" placeholder='Nomor Ref.' required/>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                if (count($sasaran) != 0) {
                                                                    ...
                                                                    foreach ($sasaran as $row_ins) {
                                                                        ...
                                                                        foreach ($jp as $row) {
                                                                            if ($row->kategori == "1") {
                                                                                echo "
                                                                                <input type='hidden' id='abjadT$no_ins1$no_kat1' value='b'>
                                                                                ...
                                                                                <div class='clearfix'>
                                                                                <select required name='pelaksana[]' class='border-red'>
                                                ...
                                                //-> KONDISI 1 INSTANSI
                                                                    ...
                                                                    foreach ($jp as $row) {
                                                                        if ($row->kategori == "1") {
                                                                            ...
                                                                            <td width='14%' class='pad-3 form-group'>
                                                                            <div class='clearfix input-group date datepicker'>
                                                                            <input type='text' name='tanggal[]' class='col-xs-10 col-sm-12' required placeholder='Tanggal'/>
                                                                            <span class='input-group-addon' title='Pilih Tanggal'><span class='ace-icon fa fa-calendar bigger-110'></span></span>
                                                                            </div>
                                                                            </td>
                                                                            <td width='7%' class='pad-3'>
                                                        ...
                                                        <div id="penyelesaian" class="tab-pane fade">
                                                            ...
                                                            <div align="center" class="clearfix form-actions">
                                                                ...
                                                                <a class="btn btn-danger" href="<?= site_url('ketua_tim/pka/tambah_pka/' . base64_encode($data->id_tugas) . '/' . base64_encode($data->id_tim) . '/' . base64_encode($data->fk_agr)); ?>">
...
<script type="text/javascript">
    ...
    function tambahElemenLkh(form_lkh, kode_ins, no_ins, kode_tbl)
    {
        ...
        if (abjad != '{')
        {
            ...
            "   <td class='pad-3 form-group'><div class='clearfix'> <select required name='pelaksana[]' class='border-red'>" +
            "       <option value='' selected> -- Pilih Pelaksana -- </option>" +
    ...
    function tambahElemenAgt(form_agt, kode_kka, kode_no)
    {
        ...
        "<div class='clearfix'>" +
        "<select required name='pelaksana[]' class='border-red' style='margin-right:3px'>" +
        "<option value='' selected> -- Pilih Pelaksana -- </option>" +
