				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active"> Ubah Alokasi Jenis Pekerjaan </li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="validasi" class="form-horizontal" role="form" action="<?php site_url('ketua_tim/pengaturan/ubah_anggaran_waktu'); ?>" method="post">
								<div class="row">
									<div class="col-md-12">
										...
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="widget-title">
													...
													Formulir Ubah Alokasi Jenis Pekerjaan
												</h4>
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<textarea name="jenis_pekerjaan" rows="3" cols="50" placeholder="Masukan jenis pekerjaan"><?= $data->jenis_pekerjaan; ?></textarea>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<?php $kat = $data->kategori_agr_wkt; ?>
															<select name="kategori">
																<option value="1" <?php if($kat == "1") { echo "selected"; } ?>> PERSIAPAN </option>
																<option value="2" <?php if($kat == "2") { echo "selected"; } ?>> PELAKSANAAN </option>
																<option value="3" <?php if($kat == "3") { echo "selected"; } ?>> PENYELESAIAN </option>
															</select>
														</div>
													</div>
