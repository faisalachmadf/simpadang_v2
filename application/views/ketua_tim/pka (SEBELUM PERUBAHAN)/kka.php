										...
										<div class="widget-main">
											...
											<table width="100%" border="1">
												...
												<tr>
													...
													<td colspan='6'> <h6 class='b'>PERSIAPAN AUDIT</h6> </td>
												</tr>
											...
											<table width="58%" border="1">
												<tr>
													...
													<th width="28%" class="c b bg-color"> KKA Ikhtisar </th>
													<th width="13%" class="c b bg-color"> Keputusan </th>
												</tr>
												 	...
												 	foreach($sub1 as $row)
													{
														...
														if($row->kategori == "1")
														{
															...
															<tr>
																...
																<td class='c'>";
																	if($cek1->jml_kka != 0)
																	{
																		if($cek1->jml_kka == $cek2->jml_kka_fix)
																		{
																			...
																			{
																				echo "<a href='#modal-kka-ikhtisar' role='button' class='btn btn-sm btn-primary' data-toggle='modal' data-id1='$row->sub_pka1' data-id2='$row->kode_pekerjaan' title='Cek hasil kertas kerja audit ikhtisar'><i class='fa fa-file-text-o'></i> Detail KKA Ikhtisar </a>";
																			}
																		}
																		else
																		{
																...
																<td class='c'>";
																	if($row->reviu_ketua == NULL)
																		{ echo "<label class='orange' title='Sedang diproses'><i class='fa fa-spinner fa-pulse bigger-130'></i> Proses </label>"; }
																	elseif($row->reviu_ketua != '-')
																		{ echo "<label class='red' title='Terdapat reviu'><i class='fa fa-times bigger-130'></i> Reviu </label>"; }
																	else
																		{ echo "<label class='green' title='Selesai'><i class='fa fa-check bigger-130'></i> Selesai </label>"; }
																echo "
