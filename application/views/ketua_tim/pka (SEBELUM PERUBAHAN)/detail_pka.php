												...
												<div class="col-sm-6">
													...
													<center>
														...
														<a href="<?= site_url('ketua_tim/pka/cetak_pka/'.base64_encode($data->id_pka)); ?>" class="btn btn-sm btn-danger" target="_blank">
															<i class="fa fa-print"></i> Cetak Program Kerja Audit
														</a>
											...
											<table width="100%" border="1">
												...
												<?php
													...
													<tr>
														...
														<td colspan='5'> <h5 class='b'>PELAKSANAAN AUDIT</h5> </td>
													</tr>";
													...
													<tr>
														...
														<td colspan='5'> <h5 class='b'>PENYELESAIAN AUDIT</h5> </td>
													</tr>";
