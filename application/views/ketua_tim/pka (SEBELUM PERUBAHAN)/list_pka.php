				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active"> Program Kerja Audit </li>
						</ul><!-- /.breadcrumb -->
					</div>
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Membuat dan mengelola program kerja audit
								</small>
							</h1>
						</div><!-- /.page-header -->
											...
											<table width="100%" id="mytable" class="table table-striped table-bordered table-hover">
												...
												foreach ($pka as $row) {
													...
													<tr>
														...
														<td> 
															$row->nama_op
															<a href='pka/detail_pka/$id' title='Detail program kerja audit'>
																<span class='pull-right'> <i class='ace-icon fa fa-list bigger-130'></i> </span>
															</a>
														</td>
														<td> $row->sasaran_peng </td>";
														...
														elseif($row->reviu_dalnis != "-")
															{ echo "<td align='center'> <a href='pka/detail_pka/$id'> <i class='ace-icon fa fa-times bigger-130 red' title='Ada direviu'></i> </a> </td>"; }
														else
