<!--
  ## DETAIL KKA IKHTISAR (KETUA TIM) ##
  Ditampilkan dalam modal bootstrap
-->

<form class='form-horizontal' role='form' action="<?= site_url('ketua_tim/pka/persetujuan_kka_ikhtisar/'.base64_encode($kka->sub_pka1).'/'.base64_encode($kka->kode_pekerjaan)); ?>" method='post'>

  <table width="100%" border="0">
    <tr>
      <td width="15%" class="pos-atas"> Jenis Pekerjaan </td>
        ...
        <tr>
          ...
          <td class='pos-atas'>";
            if($row->rev_dalnis == "-")
              ...
              { echo "<span class='red'> $row->rev_dalnis </span>"; }
          echo "
          </td>
          <td class='pos-atas'>";
            if($row->rev_daltu == "-")
              ...
              { echo "<span class='red'> $row->rev_daltu </span>"; }
          echo "
          </td>
          <td class='c pos-atas'>";            
  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <a href="<?= site_url('ketua_tim/pka/download_kka_ikhtisar/'.base64_encode($kka->kka_ikhtisar)); ?>" class='btn btn-sm btn-success' title='Download kertas kerja audit'><i class='fa fa-download'></i> KKA Ikhtisar </a>
        </div>
      </div>
