    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?= site_url('ketua_tim/anggaran_waktu/detail_anggaran_waktu/' . base64_encode($data_agr->id_anggaran_wkt)); ?>">Detail Anggaran Waktu</a>
                </li>
                <li class="active"> Reviu Anggaran Waktu </li>
            </ul><!-- /.breadcrumb -->
        </div>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <h1>
                    ...
                    <small>
                        ...
                        Mengubah alokasi anggaran waktu untuk tugas audit
                    </small>
                </h1>
            </div><!-- /.page-header -->
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form id="validasi" class="form-horizontal" role="form" action="<?php site_url('ketua_tim/anggaran_waktu/reviu_anggaran_waktu'); ?>" onsubmit="return cek_username(this)" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h4 class="widget-title">
                                            ...
                                            Formulir Reviu Anggaran Waktu Pengawasan
                                        </h4>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <!-- ID Anggaran waktu -->
                                            <input type="hidden" name="id_tgs" value="<?= $data_agr->id_tgs; ?>">
                                            ...
                                            <!-- Reviu dalnis & daltu -->
                                            <input type="hidden" name="rev_dalnis" value="<?= $data_agr->reviu_dalnis; ?>">
                                            <input type="hidden" name="rev_daltu" value="<?= $data_agr->reviu_daltu; ?>">
                                            ...
                                            <input type="hidden" name="tgl_agr" value="<?= $data_agr->tgl_agr; ?>">
                                            ...
                                            <table width="100%" border="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        if ($data_agr->reviu_dalnis == "-") {
                                                            echo "<i class='fa fa-check green'><strong> Tidak ada reviu </strong></i>";
                                                        } else {
                                                            echo "<span class='red'><strong> $data_agr->reviu_dalnis </strong></span>";
                                                        }
                                                        ?>
                                                    </td>
                                                </tr>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                        ...
                                                                                                                        <td>
                                                <?php
                                                if ($data_agr->reviu_daltu == "-") {
                                                    echo "<i class='fa fa-check green'><strong> Tidak ada reviu </strong></i>";
                                                } else {
                                                    echo "<span class='red'><strong> $data_agr->reviu_daltu </strong></span>";
                                                }
                                                ?>
                                                                                                                        </td>
                                                                                                                </tr> -->
                                            ...
                                            <table width="100%" border="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pad-3">
                                                        <div class='input-group date datepicker'>
                                                            ...
                                                            <input required type='text' name='tgl1_persiapan' class='col-xs-12 col-sm-12' placeholder='Dari Tanggal' value="<?= $data_agr->tgl1_persiapan; ?>" />
                                                    ...
                                                    <td>
                                                        <div class='input-group date datepicker'>
                                                            <span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
                                                            <input required type='text' name='tgl2_persiapan' class='col-xs-12 col-sm-12' placeholder='Tanggal' value="<?= $data_agr->tgl2_persiapan; ?>" />
                                                            <span class='input-group-addon' title='Ubah tanggal'><span class='glyphicon glyphicon-remove'></span></span>
                                                        </div>
                                                    </td>
                                                    <td></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pad-3">
                                                        <div class='input-group date datepicker'>
                                                            <span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
                                                            <input required type='text' name='tgl1_pelaksanaan' class='col-xs-12 col-sm-12' placeholder='Dari Tanggal' value="<?= $data_agr->tgl1_pelaksanaan; ?>" />
                                                            <span class='input-group-addon' title='Ubah tanggal'><span class='glyphicon glyphicon-remove'></span></span>
                                                        </div>
                                                    </td>
                                                    <td class="c">s/d</td>
                                                    <td>
                                                        <div class='input-group date datepicker'>
                                                            <span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
                                                            <input required type='text' name='tgl2_pelaksanaan' class='col-xs-12 col-sm-12' placeholder='Tanggal' value="<?= $data_agr->tgl2_pelaksanaan; ?>" />
                                                            <span class='input-group-addon' title='Ubah tanggal'><span class='glyphicon glyphicon-remove'></span></span>
                                                        </div>
                                                    </td>
                                                    <td></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pad-3">
                                                        <div class='input-group date datepicker'>
                                                            <span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
                                                            <input required type='text' name='tgl1_penyelesaian' class='col-xs-12 col-sm-12' placeholder='Dari Tanggal' value="<?= $data_agr->tgl1_penyelesaian; ?>" />
                                                            <span class='input-group-addon' title='Ubah tanggal'><span class='glyphicon glyphicon-remove'></span></span>
                                                        </div>
                                                    </td>
                                                    <td class="c">s/d</td>
                                                    <td>
                                                        <div class='input-group date datepicker'>
                                                            <span class='input-group-addon'><i class="ace-icon fa fa-calendar bigger-110"></i></span>
                                                            <input required type='text' name='tgl2_penyelesaian' class='col-xs-12 col-sm-12' placeholder='Tanggal' value="<?= $data_agr->tgl2_penyelesaian; ?>" />
                                                            <span class='input-group-addon' title='Ubah tanggal'><span class='glyphicon glyphicon-remove'></span></span>
                                                        </div>
                                                    </td>
                                                    <td></td>
                                                ...
                                                foreach ($sub_agr as $row) {
                                                    if ($row->kategori == "2") {
                                                        ...
                                                        echo "
                                                            ...
                                                            <td class='pad-3'><textarea name='jenis_pekerjaan[]' rows='2' cols='47' style='color:black;'>$row->jenis_pekerjaan</textarea>
                                                            <input type='hidden' name='kategori[]' value='$row->kategori'>
                                                            <input type='hidden' name='kode_pekerjaan[]' value='$row->kode_pekerjaan'></td>
                                                            <td class='pad-3 pos-top'>
                                                                <div class='radio'>
                                                                    <label title='Wakil Penanggung Jawab Nonaktif'>
                                                                        <input type='radio' name='daltu_$row->nomor' data-no='$row->nomor' class='ace inpDaltu' value='nonaktif'";
