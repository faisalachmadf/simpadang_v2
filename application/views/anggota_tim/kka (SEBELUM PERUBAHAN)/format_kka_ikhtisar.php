<?php
  ...
  $jp  = strtoupper($sub_pka1->jenis_pekerjaan);
	header("Content-type: application/vnd.ms-word");
	header("Content-Disposition: attachment;Filename=KKA-IKHTISAR-[$pka->id_pka]-[$jp]-[$tgl].doc");
?>
...
<html>
  ...
  <body>
    ...
    <h4> 
      ...
      tentang <br/>
      <?= strtoupper($sub_pka1->jenis_pekerjaan); ?>
    </h4>
