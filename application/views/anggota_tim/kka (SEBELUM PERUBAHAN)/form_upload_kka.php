...
<form class='form-horizontal' role='form' action="<?= site_url('anggota_tim/kka/upload_kka/'.base64_encode($kka->sub_pka3).'/'.base64_encode($kka->sub_no_kka).'/'.base64_encode($kka->pelaksana)); ?>" method='post' enctype='multipart/form-data'>
