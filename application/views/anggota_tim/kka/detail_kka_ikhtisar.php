				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('anggota_tim/kka/detail_kka/'. base64_encode($data->id_pka)); ?>"> Detail Kertas Kerja Audit </a>
							</li>
							<li class="active"> Detail Kertas Kerja Audit Ikhtisar </li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Detail Kertas Kerja Audit Ikhtisar
								<small>
									<i class="ace-icon fa fa-angle-double-right"></i>
									Melihat rincian data KKA  Ikhtisar anggota tim
								</small>
							</h1>
						</div><!-- /.page-header -->
										...
										<div class="widget-main">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														<a href="<?= site_url('anggota_tim/kka/detail_kka/'. base64_encode($data->id_pka)); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>
													</center>
											...
											<table width="67%" border="1">
												...
												<tr>
													...
													<td colspan='5'> <h6 class='b u'>PERSIAPAN AUDIT</h6> </td>
												</tr>
																...
																if($row->kategori == "1" && $row->nama_instansi == $key->nama_instansi)
																{
																	...
																	foreach($kka_ikhtisar as $row2)
																	{
																		...
																		$cek1 = $this->db->select('count(*) as jml_kka')
																										...
																										->where('sub_pka3', $row2->sub_pka3)
																										->where('sub_no_kka', $row2->sub_no_kka)
																			...
																			<tr>
																				...
																				<td class='c'>";
																					if($cek1->jml_kka == $cek2->jml_kka_fix)
																					{
																						...
																						{
																							echo "<a href='".site_url('anggota_tim/kka/download_format_kka_ikhtisar/'.base64_encode($data->id_tgs).'/'.base64_encode($row2->sub_pka2).'/'.base64_encode($row2->no_kka))."' class='btn btn-sm btn-danger' title='Download format KKA Ikhtisar'><i class='fa fa-file-text-o'></i> Format KKA Ikhtisar </a>";
																						}
																						else
																						{
																							echo "<a href='".site_url('anggota_tim/kka/download_kka_ikhtisar/'.base64_encode($row2->kka_ikhtisar))."' class='btn btn-sm btn-primary' title='Download KKA Ikhtisar'><i class='fa fa-cloud-download'></i> Download KKA Ikhtisar </a>";
																						}
																					}
																					else
																					{
																				...
																				<td class='c'>";
																					if($cek1->jml_kka == $cek2->jml_kka_fix)
																					{
																						if(($row2->reviu_ketua == NULL) && ($row2->reviu_dalnis == NULL)) //&& ($row2->reviu_daltu == NULL))
																						{
																							echo "
																							<a href='#modal-upload-kka-ikhtisar' role='button' class='btn btn-sm btn-success' data-toggle='modal' data-id1='$row2->sub_pka2' data-id2='$row2->no_kka' title='Upload KKA Ikhtisar'><i class='fa fa-cloud-upload'></i> Hasil KKA </a>";
																						}
																						else
																						{
																							echo "
																							<a href='#modal-detail-kka-ikhtisar' role='button' class='btn btn-sm btn-warning' data-toggle='modal' data-id1='$row2->sub_pka2' data-id2='$row2->no_kka' title='Detail KKA Ikhtisar'><i class='fa fa-list'></i> Detail KKA </a>";
																						}
																					}
																					else
																					{
																				...
																				<td class='c'>";
																					if($row2->keputusan_kka_ikhtisar == 'belum')
																						{ echo "-"; }
																					elseif($row2->keputusan_kka_ikhtisar == 'proses')
																						{ echo "<label class='orange' title='Sedang diproses'><i class='fa fa-spinner fa-pulse bigger-130'></i> Proses </label>"; }
																					elseif($row2->keputusan_kka_ikhtisar == 'reviu')
																						{ echo "<a href='#modal-reviu-ikhtisar' role='button' data-toggle='modal' data-id1='$row2->sub_pka2' data-id2='$row2->no_kka' title='Aksi reviu kka ikhtisar' class='red'><i class='fa fa-times bigger-130'></i> Reviu </a> "; }
																					else
