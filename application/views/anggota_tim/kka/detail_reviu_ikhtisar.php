...
<?php
if($kka->reviu_ketua != NULL && $kka->reviu_ketua != "-") 
{
/*if(($kka->reviu_ketua != NULL) && ($kka->reviu_dalnis != NULL) && ($kka->reviu_daltu != NULL))
{
  ...
  {*/
?>
    <form class='form-horizontal' role='form' action="<?= site_url('anggota_tim/kka/upload_reviu_kka_ikhtisar/'.base64_encode($kka->sub_pka2).'/'.base64_encode($kka->no_kka)); ?>" method='post' enctype='multipart/form-data'>
