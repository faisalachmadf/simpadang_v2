											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														...
														<a href="<?= site_url('anggota_tim/kka/detail_kka_ihktisar/'. base64_encode($data->id_pka)); ?>" class="btn btn-sm btn-primary"><i class="fa fa-file-text-o"></i> Kertas Kerja Audit (KKA) Ikhtisar </a>
													</center>
