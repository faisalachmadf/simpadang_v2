...
<html>
  <head>
		...
		<title> Reviu Kertas Kerja Audit : <?= $kka->sub_no_kka; ?> </title>
	...
	<body>
		...
		<div class="border"><h6 class='c b'> LEMBAR REVIU KKA </h6></div>
		...
		<table width="100%" border="1">
				...
				foreach($data_rev as $row)
	      {
	        ...
	        <tr>
	          ...
	          <td class='pos-atas'> $row->rev_kka_ketua";
	          	/*if($row->rev_kka_ketua != "-" && $row->rev_kka_dalnis == '-' && $row->rev_kka_daltu == '-')
							{ echo $row->rev_kka_ketua; }
							elseif($row->rev_kka_ketua == "-" && $row->rev_kka_dalnis == '-' && $row->rev_kka_daltu != '-')
							{ echo $row->rev_kka_daltu; }
							elseif($row->rev_kka_ketua == "-" && $row->rev_kka_dalnis != '-' && $row->rev_kka_daltu == '-')
							{ echo $row->rev_kka_dalnis; }
							elseif($row->rev_kka_ketua == "-" && $row->rev_kka_dalnis != '-' && $row->rev_kka_daltu != '-')
							{ echo $row->rev_kka_dalnis .", ". $row->rev_kka_daltu; }
							elseif($row->rev_kka_ketua != "-" && $row->rev_kka_dalnis == '-' && $row->rev_kka_daltu != '-')
							{ echo $row->rev_kka_ketua .", ". $row->rev_kka_daltu; }
							elseif($row->rev_kka_ketua != "-" && $row->rev_kka_dalnis != '-' && $row->rev_kka_daltu == '-')
							{ echo $row->rev_kka_ketua .", ". $row->rev_kka__dalnis; }*/
	          echo "</td>
