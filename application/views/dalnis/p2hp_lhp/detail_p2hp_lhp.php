				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('dalnis/p2hp_lhp'); ?>"> P2HP & LHP </a>
							</li>
										...
										<div class="widget-main">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														<a href="<?= site_url('dalnis/p2hp_lhp'); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>
													</center>
											...
											<div class="row">
												...
												<form class='form-horizontal' role='form' action="<?= site_url('dalnis/p2hp_lhp/persetujuan_p2hp/'.base64_encode($p2hp->id_p2hp).'/'.base64_encode($data->id_pka).'/'.base64_encode($data->id_tgs)); ?>" method='post'>
												<div class="col-sm-6">
													<h3 class="header">
											        ...
											        <div class="col-sm-12">
											        	...
											        	<div class="form-group">
													        ...
													        <div class="col-sm-8">
													        	...
													        	<a href='<?= site_url('dalnis/p2hp_lhp/download_p2hp/'.base64_encode($p2hp->file_p2hp)); ?>' class='btn btn-sm btn-success' title='Download file P2HP'><i class='fa fa-download'></i> File P2HP </a>
													          <?php } else
													          	{
											      ...
											      <div class="form-group">
											        ...
											        <div class="col-sm-8">
											          <textarea name="catatan" cols="40" rows="3" placeholder="Isi reviu P2HP"></textarea>
											        </div>
											      </div>
											      </div>
														...
														<?php
															...
															foreach($data_rev_p2hp as $row)
															{
																...
																<tr>
																	...
																	<td class='c'>
																		<a href='". site_url('dalnis/p2hp_lhp/download_rev_p2hp/'.base64_encode($row->rev_file_p2hp))."' class='btn btn-sm btn-success' title='Download file P2HP'> <i class='fa fa-download'></i> </a>
																	</td>
																</tr>
																";
																$no++;
												...
												<form class='form-horizontal' role='form' action="<?= site_url('dalnis/p2hp_lhp/persetujuan_lhp/'.base64_encode($lhp->no_lhp) .'/'.base64_encode($p2hp->id_p2hp) .'/'.base64_encode($data->id_pka)); ?>" method='post'>
												<div class="col-sm-6">
													<h3 class="header">
											        	...
											        	<div class="form-group">
													        ...
													        <div class="col-sm-8">
													        	<?php if($lhp->keputusan_lhp != "belum") { ?>
													        		<a href='<?= site_url('dalnis/p2hp_lhp/download_lhp/'.base64_encode($lhp->file_lhp)); ?>' class='btn btn-sm btn-success' title='Download file LHP'><i class='fa fa-download'></i> File LHP </a>
													          <?php } else
													          	{
													          		echo "<label class='control-label orange i'><i class='ace-icon fa fa-spinner fa-pulse bigger-130'></i> Belum Dibuat</label>";
													          	}
														...
														<?php
															...
															foreach($data_rev_lhp as $row)
															{
																...
																<tr>
																	...
																	<td class='c'> $rev_daltu </td>
																	<td class='c'>
																		<a href='". site_url('dalnis/p2hp_lhp/download_rev_lhp/'.base64_encode($row->rev_file_lhp))."' class='btn btn-sm btn-success' title='Download file LHP'> <i class='fa fa-download'></i> </a>
																	</td>
																</tr>
																";
																$no++;
