				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('dalnis/pka/detail_pka/'.base64_encode($data->id_pka)); ?>"> Detail Program Kerja Audit </a>
							</li>
										...
										<div class="widget-main">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														<a href="<?= site_url('dalnis/pka/detail_pka/'.base64_encode($data->id_pka)); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>
													</center>
												</div>
											</div>
...
<?php $this->load->view('layout/footer'); ?>
        ...
        $.ajax({
            type : 'post',
            url  : "<?= site_url('dalnis/pka/detail_kka'); ?>",
        ...
        $.ajax({
            type : 'post',
            url  : "<?= site_url('dalnis/pka/detail_kka_ikhtisar'); ?>",
