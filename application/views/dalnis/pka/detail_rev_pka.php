				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('dalnis/pka/detail_pka/'.base64_encode($data->rev_pka1)); ?>"> Detail Program Kerja Audit </a>
							</li>
										...
										<div class="widget-main">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														<a href="<?= site_url('dalnis/pka/detail_pka/'.base64_encode($data->rev_pka1)); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>
													</center>
												</div>
