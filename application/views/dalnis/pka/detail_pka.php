				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('dalnis/pka'); ?>"> Program Kerja Audit </a>
							</li>
										...
										<div class="widget-main">
											...
											<div class="row">
														...
														<?php 
															...
															foreach($data_rev as $row)
															{
																...
																<tr>
																	...
																	<td class='c'>
																		<a href='". site_url('dalnis/pka/detail_reviu/'.base64_encode($row->rev_pka1).'/'.base64_encode($row->rev_ke))."' title='Detail Reviu'> <i class='fa fa-eye bigger-130'></i> </a>
																	</td>
																</tr>
																";
																$no++;
												...
												<div class="col-sm-6">
													...
													<form class="form-horizontal" role="form" action="<?= site_url('dalnis/pka/persetujuan/'. base64_encode($data->id_pka)); ?>" method="post">
													<dl id="dt-list-1" class="dl-horizontal">
													...
													<?php 
														...
														{ 
															echo " &nbsp;&nbsp;
															<a href='". site_url('dalnis/pka/kka/'.base64_encode($data->id_pka)) ."' class='btn btn-sm btn-primary'>
													...
													<center>
														<a href="<?= site_url('dalnis/pka'); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>			
													</center>
