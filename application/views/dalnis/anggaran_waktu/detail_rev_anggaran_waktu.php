				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?= site_url('dalnis/anggaran_waktu/detail_anggaran_waktu/'.base64_encode($data->rev_agr1)); ?>"> Detail Anggaran Waktu </a>
							</li>
										...
										<div class="widget-main">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														<a href="<?= site_url('dalnis/anggaran_waktu/detail_anggaran_waktu/'.base64_encode($data->rev_agr1)); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>
													</center>											
												</div>
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<table width="100%" border="1">
													...
													<tr>
														<td colspan="2" class="c b bg-color"> JENIS KEGIATAN </td>
														<td class="c b bg-color">PENGENDALI MUTU <br/> (HP/Jam)</td>
														<td class="c b bg-color">PENGENDALI TEKNIS <br/> (HP/Jam)</td>
														<td class="c b bg-color">KETUA TIM <br/> (HP/Jam)</td>
														<td class="c b bg-color">ANGGOTA TIM <br/> (HP/Jam)</td>
														<td class="c b bg-color">JUMLAH <br/> (HP/Jam)</td>
