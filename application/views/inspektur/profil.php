								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="tabbable">
											...
											<form class="form-horizontal" role="form" action="<?=site_url('inspektur/home/setting_ubah/'. base64_encode($pegawai->id_pegawai)); ?>" method="post">
													...
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<label class="control-label"> <?=$pegawai->nip; ?> </label>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<label class="control-label"> <?=$pegawai->pangkat; ?> </label>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<label class="control-label"> <?=$pegawai->golongan; ?> </label>
																</div>
															</div>
