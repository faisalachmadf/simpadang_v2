											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<center>
														...
														<a target="_blank" href="<?= site_url('inspektur/temuan/cetak_temuan/'. $temuan->id_temuan .' '); ?>" class="btn btn-primary"><i class="fa fa-print"></i> Cetak Temuan </a>
													</center>
												</div>
...
<script type="text/javascript">
	$('#modal-kat').on('show.bs.modal', function(e)
	{
		...
		$.ajax({
			type : 'post',
			url  : "<?= site_url('inspektur/temuan/get_status'); ?>",
			data : {id1:id1},
...
<script type="text/javascript">
	$('#modal-upload').on('show.bs.modal', function(e)
	{
		...
		$.ajax({
			type : 'post',
			url  : "<?= site_url('inspektur/temuan/get_upload'); ?>",
			data : {id1:id1},
			success : function(data)
			{
				$('.isi-data').html(data);
