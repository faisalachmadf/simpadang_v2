							...
							<div class="col-md-12">
								...
								<div class="widget-box">
									...
									<div class="widget-body" style="display: block; overflow: hidden;">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class='input-group date datepicker2'>
														...
														<input required type='text' class='col-xs-8 col-sm-2' value="<?php echo date('Y-m-d')?>" placeholder='Tanggal' />
													</div>
												</div>
											</div>
										...
										<?php $no_spi = 1;
										foreach ($aspeks as $spi)
											{?>
												<div class="col-md-12 list list-temuan-1" style="border: 1px solid #cdd8e3;background:#fdfdfd;min-height: 250px;padding: 10px;margin-top: 10px;margin-bottom:10px;">
													<h5><b><span>TEMUAN <span class="no"><?php echo $no_spi ?></span></span></b></h5>
													<hr>
													<div class="col-md-12 no-padding">
														<div class="col-md-3 no-padding-left">
															<select class="form-control">
											<?php if($spi->aspek == 'spi') { ?>
											<option value="spi" disabled selected>Sistem Pengendalian Internal (SPI)</option>
											<option value="e3" disabled>Efektif, Efisien, Ekonomis(EEE)</option>
											<option value="kepatuhan" disabled>Kepatuhan</option>
											<?php } else if ($spi->aspek == 'e3') { ?>
											<option value="spi" disabled>Sistem Pengendalian Internal (SPI)</option>
											<option value="e3"  disabled selected>Efektif, Efisien, Ekonomis(EEE)</option>
											<option value="kepatuhan" disabled>Kepatuhan</option>
											<?php } else if ($spi->aspek == 'kepatuhan') { ?>
											<option value="spi" disabled>Sistem Pengendalian Internal (SPI)</option>
											<option value="e3" disabled>Efektif, Efisien, Ekonomis(EEE)</option>
											<option value="kepatuhan" disabled selected>Kepatuhan</option>
											<?php } else { ?>
											<option value="spi" disabled>Sistem Pengendalian Internal (SPI)</option>
											<option value="e3" disabled>Efektif, Efisien, Ekonomis(EEE)</option>
											<option value="kepatuhan" disabled>Kepatuhan</option>
							...
							<div class="form-group">
								...
								<div class="col-md-10 no-padding-right ">
									<div class="col-sm-12 no-padding-right ">
										...
										<textarea required name="uraian_tindak_lanjut[]" placeholder="Tindak Lanjut" class="autosize-transition rekom form-control"><?php echo $rek_spi->uraian_tindak_lanjut ?></textarea>
									</div>
								</div>
