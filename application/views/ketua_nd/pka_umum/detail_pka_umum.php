                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                   ...
                                                   <!--  <h3 class="header">
                                                    ...
                                                    <center>
                                                        <a href="<?= site_url('ketua_nd/pka_umum'); ?>" class="btn btn-sm btn-default"><i class="fa fa-arrow-left"></i> Kembali </a>
                                                         &nbsp;&nbsp;
                                                      
                                                            <a href="<?= site_url('ketua_nd/pka_umum/cetak_pka_umum/'.$notadinass["notadinas_id"].''); ?>" class="btn btn-sm btn-danger" target="_blank"><i class="fa fa-print"></i> Cetak Nota Dinas </a>
                                                        &nbsp;&nbsp;
                                                            <a href="#" class="btn btn-sm btn-success">
                                                            <i class="fa fa-file-text"></i> Buat PKA UMUM</a>
