...
class Temuan extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('sekretaris/temuan/list_temuan', $data);
	}
	...
	public function detail_temuan($id_temuan)
	{
		...
		$this->load->view('sekretaris/temuan/detail_temuan', $data);
	}
	...
	public function cetak_temuan($id_temuan)
	{
		...
		$html = $this->load->view('sekretaris/temuan/cetak_temuan', $data, TRUE);
	...
	public function get_status()
    {
        ...
        $this->load->view('sekretaris/temuan/get_status', $data);
    }
    ...
    public function get_upload()
    {
        ...
        $this->load->view('sekretaris/temuan/get_upload', $data);
    }
