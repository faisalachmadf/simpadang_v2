...
class Penugasan extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('sekretaris/penugasan/list_penugasan', $data);
	}
	...
	public function detail_penugasan($id_tugas, $id_tim)
	{
		...
		$this->notifikasi_m->update_notif_sekretaris($key);
		...
		$this->load->view('sekretaris/penugasan/detail_penugasan', $data);
	}
	...
	public function detail_reviu($id_tugas, $no_rev)
	{
		...
		$this->load->view('sekretaris/penugasan/detail_reviu', $data);
	}
	...
	public function persetujuan($id_tugas)
	{
		...
		$this->penugasan_m->persetujuan_sekretaris($key);
		...
		echo $this->session->set_flashdata('sukses',
				 "<div class='alert alert-block alert-success'>
						...
						<p>
							...
							Rencana penugasan telah di reviu oleh sekretaris, cek data tersebut di bawah ini.
						</p>
					</div>"
			);

		redirect('sekretaris/penugasan/detail_penugasan/'.$id_tugas.'/'.$key2);
	}
