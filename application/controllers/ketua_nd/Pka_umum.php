...
class Pka_umum extends CI_Controller {
 ...
 public function index()
 {
  ...
  $data = array(
     ...
     'tugas'        => $this->notadinas_m->get_notadinas_by_ketua($kt->id_pegawai)
 );
       // print "<pre>"; print_r($data); die;
  $this->load->view('ketua_nd/pka_umum/list_pka_umum', $data);
}
...
/*public function tambah_notadinas() {
  ...
  public function detail_pka_umum($id)
  {
    ...
    $this->load->view('ketua_nd/pka_umum/detail_pka_umum', $data);
    
  }

  function cek_notadinas(){

    $this->load->view('irban/notadinas/cetak_pka_umum');
  }

    //--> cetak surat tugas
  public function cetak_pka_umum($id, $id_tim)
  {
    $get_akun = $this->login_model->get_user($this->session->userdata('username'), $this->session->userdata('lvl'));
    $kt = $this->login_model->get_pegawai($this->session->userdata('username'));
...
*/
       ...
       $data = array(
        ...
        $html = $this->load->view('ketua_nd/pka_umum/cetak_pka_umum', $data, true);
