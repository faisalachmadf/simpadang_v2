...
class P2hp_lhp extends CI_Controller {
	...
	public function index()
	{
		...
		$data = array(
				...
				'title'        => 'P2HP & LHP [DALTU]',
				'p2hp_lhp'     => $this->p2hp_lhp_m->get_p2hp_dt($dt->id_pegawai)
			);

		$this->load->view('daltu/p2hp_lhp/list_p2hp_lhp', $data);
	}
	...
	public function detail_p2hp_lhp($id_p2hp, $id_pka)
	{
		...
		$this->load->view('daltu/p2hp_lhp/detail_p2hp_lhp', $data);
	}
	...
	public function persetujuan_p2hp($id_p2hp, $id_pka, $id_tgs)
	{
		...
		$this->p2hp_lhp_m->persetujuan_p2hp_daltu($key1, $key2, $key3);
		...
		redirect('daltu/p2hp_lhp/detail_p2hp_lhp/'.$id_p2hp .'/'. $id_pka);
	}
	...
	public function persetujuan_lhp($no_lhp, $id_p2hp, $id_pka)
	{
		...
		$this->p2hp_lhp_m->persetujuan_lhp_daltu($key, $key2);
		...
		echo $this->session->set_flashdata('sukses',
				 "<div class='alert alert-block alert-success'>
						...
						<p>
							...
							LHP telah di reviu oleh DALTU, cek data tersebut di bawah ini.
						</p>
					</div>"
			);
