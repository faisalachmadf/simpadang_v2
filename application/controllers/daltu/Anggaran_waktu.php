...
class Anggaran_waktu extends CI_Controller {
	...
	public function index()
	{
		...
		$data = array(
				...
				'title'        => 'Anggaran Waktu [DALTU]',
				'agr'          => $this->anggaran_waktu_m->get_anggaran_waktu_dt($dt->id_pegawai)
			);

		$this->load->view('daltu/anggaran_waktu/list_anggaran_waktu', $data);
	}
	...
	public function detail_anggaran_waktu($id_agr)
	{
		...
		$this->load->view('daltu/anggaran_waktu/detail_anggaran_waktu', $data);
	}
	...
	public function detail_reviu($id_agr, $no_rev)
	{
		...
		$this->load->view('daltu/anggaran_waktu/detail_rev_anggaran_waktu', $data);
	}
	...
	public function persetujuan($id_agr)
	{
		...
		$this->anggaran_waktu_m->persetujuan_daltu($key);
		...
		redirect('daltu/anggaran_waktu/detail_anggaran_waktu/'.$id_agr);
	}
