...
class Pka extends CI_Controller {
	...
	public function index()
	{
		...
		$data = array(
				...
				'title'        => 'Program Kerja Audit [DALTU]',
				'pka'          => $this->pka_m->get_pka_dt($dt->id_pegawai)
			);

		$this->load->view('daltu/pka/list_pka', $data);
	}
	...
	public function detail_pka($id_pka)
	{
		...
		$this->notifikasi_m->update_notif_daltu($key);
		...
		$this->load->view('daltu/pka/detail_pka', $data);
	}
	...
	public function detail_reviu($id_pka, $no_rev)
	{
		...
		$this->load->view('daltu/pka/detail_rev_pka', $data);
	}
	...
	public function persetujuan($id_pka)
	{
		...
		$this->pka_m->persetujuan_daltu($key);
		...
		echo $this->session->set_flashdata('sukses',
				 "<div class='alert alert-block alert-success'>
						...
						<p>
							...
							Rencana PKA telah di reviu oleh Pengendali Mutu, cek data tersebut di bawah ini.
						</p>
					</div>"
			);

		redirect('daltu/pka/detail_pka/'.$id_pka);
	}
	...
	function kka($id_pka)
	{
		...
		$this->load->view('daltu/pka/kka', $data);
	}
	...
	public function detail_kka()
	{
		...
		$data['kka']      = $this->pka_m->get_row_kka($no_kka, $pelaksana);
		...
		$this->load->view('daltu/pka/detail_kka', $data);
	}
	...
	public function detail_kka_ikhtisar()
	{
		...
		$this->load->view('daltu/pka/detail_kka_ikhtisar', $data);
	}
	...
	public function persetujuan_kka($id_pka, $no_kka, $anggota)
	{
		...
		$this->pka_m->persetujuan_kka_daltu($key, $key2, $key3);
		...
		echo $this->session->set_flashdata('sukses',
				 "<div class='alert alert-block alert-success'>
						...
						<p>
							...
							Kertas Kerja Audit telah di reviu oleh Pengendali Mutu, cek data tersebut di detail KKA.
						</p>
					</div>"
			);

		redirect('daltu/pka/kka/'.$id_pka);
	}
	...
	public function persetujuan_kka_ikhtisar($id_pka, $no_kka)
	{
		...
		$this->pka_m->persetujuan_kka_ikhtisar_daltu($key, $key2);
		...
		echo $this->session->set_flashdata('sukses',
				 "<div class='alert alert-block alert-success'>
						...
						<p>
							...
							Kertas Kerja Audit Ikhtisar telah di reviu oleh Pengendali Mutu, cek data tersebut di detail KKA Ikhtisar.
						</p>
					</div>"
			);
