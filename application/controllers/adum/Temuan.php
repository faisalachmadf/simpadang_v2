...
class Temuan extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('adum/temuan/list_temuan', $data);
	}
	...
	public function detail_temuan($id_temuan)
	{
		...
		$this->notifikasi_m->update_notif_adum_temuan($id_temuan);
		...
		$this->load->view('adum/temuan/detail_temuan', $data);
	}
	...
	public function cetak_temuan($id_temuan)
	{
		...
		/*$this->load->view('adum/temuan/cetak_temuan', $data);*/

		$pdf = $this->pdf->load_landscape();
		
		$html = $this->load->view('adum/temuan/cetak_temuan', $data, TRUE);
	...
	public function get_status()
    {
        ...
        $this->load->view('adum/temuan/get_status', $data);
    }
    ...
    public function get_upload()
    {
        ...
        $this->load->view('adum/temuan/get_upload', $data);
    }
