...
class Tindak_lanjut extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('adum/tindak_lanjut/list_tl', $data);
	}
	...
	public function detail_tl($id_tl, $id_tim)
	{
		...
		$this->load->view('adum/tindak_lanjut/detail_tl', $data);
	}
	...
	public function detail_reviu($id_tl, $no_rev)
	{
		...
		$this->load->view('adum/tindak_lanjut/detail_reviu', $data);
	}
	...
	public function persetujuan($id_tl)
	{
		...
		$this->tindak_lanjut_m->persetujuan_adum($key);
		...
		redirect('adum/tindak_lanjut/detail_tl/'.$id_tl.'/'.$key2);
	}
